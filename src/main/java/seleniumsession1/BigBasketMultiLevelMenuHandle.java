...
//		Thread.sleep(1500);
//		WebElement level2 = driver.findElement(By.linkText("Bakery, Cakes & Dairy"));
//		act.moveToElement(level2).perform();
//		Thread.sleep(1500);
//		WebElement level3 = driver.findElement(By.linkText("Cookies, Rusk & Khari"));
//		act.moveToElement(level3).perform();
//		Thread.sleep(1500);
//		WebElement level4 = driver.findElement(By.linkText("Premium Cookies"));
